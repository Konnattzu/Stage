<?php
    class Spreadsheet{
        ...
        public function idSet($cell){
            for($j=0;$j<count($cell[0]);$j++){
                $identifier[$j] = $cell[0][$j];
            }
        }
        ...
        public function colSet($header, $cell){
            $this->header = $header;
        }
